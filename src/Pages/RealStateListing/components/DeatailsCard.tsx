    ...
    return (
        <>
            <>
                ...
                <div className={`${showDetailsBox ? ("flex fixed bg-white top-0.5 m-10 bottom-0 left-20 right-0 xsm:m-0 xsm:left-5 xsm:top-10 md:top-16 md:h-[80vh]  border border-black rounded-xl h-[90vh]  justify-center item xsm:w-[90vw] md:border md:border-green-400 ") : ("hidden")}`} >
                    <AllDetailsBox property={property} setDetailsBox={setDetailsBox} />
                </div>

                <div className="  flex flex-col justify-around items-center  rounded-3xl bg-blue-200 w-[25vw] h-96 p-10 xsm:p-0 xsm:w-[38vw] md:p-0 md:w-[20vw]  " >
