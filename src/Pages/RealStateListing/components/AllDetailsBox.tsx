            ...
            <div className=" bg-gray-200 rounded-xl xsm:w-[90vw] md:h-[80vh] md:w-[80vw]" >
                ...
                <div className="flex overflow-x-auto overflow-y-auto xsm:overflow-x-hidden xsm:flex-col  h-80 md:overflow-x-hidden  md:flex-col" >
                    <div className="p-5 flex flex-col gap-5 xsm:p-0" >
                        ...
                        <div className="px-3">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/iRV-XdwRkO4?si=xjx02mm0W29z-Gc8" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" className="xsm:w-[85vw]" ></iframe>
                        </div>
                    </div>
